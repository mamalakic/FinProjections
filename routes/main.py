...
def dashboard():
    ...
    return render_template(template, projections=projections, currency=currency, date_format=date_format)
...
def income():
    ...
    return render_template(template, recurring=recurring, one_time=one_time, currency=currency, date_format=date_format)
...
def settings():
    ...
    return render_template(template, currency=currency, date_format=date_format)
...
def wishlist():
    ...
    return render_template(template, items=items, currency=currency, date_format=date_format)
